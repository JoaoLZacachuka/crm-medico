...
import { Stethoscope, LayoutDashboard, Users, Calendar, UserPlus, Settings, LogOut, Menu, X } from "lucide-react"

const navigation = [
  { name: "Painel", href: "/dashboard", icon: LayoutDashboard },
  { name: "Pacientes", href: "/dashboard/patients", icon: Users },
  { name: "Consultas", href: "/dashboard/appointments", icon: Calendar },
  { name: "Novo Paciente", href: "/dashboard/patients/new", icon: UserPlus },
]
        ...
        <div className="fixed inset-y-0 left-0 flex w-64 flex-col bg-white shadow-xl">
          <div className="flex h-16 items-center justify-between px-4 border-b">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-gray-900">MediCRM</span>
            </div>
