...
function ResetPasswordForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Passe o accessToken para a função updatePassword, caso necessário
      await updatePassword(formData.password, accessToken)
      setSuccess(true)
      setTimeout(() => {
        router.push('/login')
      }, 2000)
    ...
    <Card className="shadow-xl border-0">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <CardFooter className="flex flex-col space-y-4">
          ...
          <a href="/login" className="flex items-center justify-center text-sm text-gray-600 hover:text-gray-900">
